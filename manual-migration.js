...
async function runMigration() {
  ...
  try {
    ...
    await run(`CREATE TYPE "public"."telegram_scheduled_post_status" AS ENUM('active', 'paused', 'completed')`, 'Created ENUM telegram_scheduled_post_status');
    
    await run(`
      CREATE TABLE IF NOT EXISTS "advanced_crash_settings" (
    ...
    `, 'Created TABLE advanced_crash_settings');
    ...
    `, 'Created TABLE telegram_scheduled_posts');
